        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          >
            <div className="relative">
              ...
              <span
                className="text-[8rem] sm:text-[10rem] lg:text-[12rem] font-bold leading-none text-border/60 select-none"
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground -mt-8 lg:-mt-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {formats.map((format, i) => (
                  ...
                  >
                    <div className="px-4 py-3 bg-[var(--paper-cream)] border border-border/60 rounded-sm shadow-sm hover:shadow-md transition-shadow">
                      <div className="text-lg font-bold text-foreground">{format.name}</div>
                      <div className="text-[10px] uppercase tracking-wider text-muted-foreground/70">{format.desc}</div>
                    </div>
                  </motion.div>
                ))}
              </div>
