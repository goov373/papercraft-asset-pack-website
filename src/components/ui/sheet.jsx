...
/**
 * Sheet - Paper panel that slides from edge
 *
 * Papercraft treatment:
 * - Warm paper background with elevation
 * - Slides in like a paper being pulled from a folder
 * - Close button with paper press states
 */
function Sheet({
  ...props
}) {
