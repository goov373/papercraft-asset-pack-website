    ...
    <div>
      ...
      >
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Default (Fold Line)</h4>
            <p className="text-sm text-amber-600 mb-4">A subtle paper fold line divider.</p>
            <div className="py-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Variant: Fold</h4>
            <p className="text-sm text-amber-600 mb-4">Paper crease with shadow effect.</p>
            <div className="py-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Variant: Torn</h4>
            <p className="text-sm text-amber-600 mb-4">Rough paper tear edge.</p>
            <div className="py-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Variant: Cut</h4>
            <p className="text-sm text-amber-600 mb-4">Clean paper cut with subtle shadow.</p>
            <div className="py-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Variant: Dashed</h4>
            <p className="text-sm text-amber-600 mb-4">Scissors cut guide line.</p>
            <div className="py-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Variant: Dotted</h4>
            <p className="text-sm text-amber-600 mb-4">Perforation line for tearing.</p>
            <div className="py-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Vertical Orientation</h4>
            <p className="text-sm text-amber-600 mb-4">Separators can also be vertical.</p>
      ...
      >
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Basic Table</h4>
            <Table>
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Interactive Rows</h4>
            <p className="text-sm text-amber-600 mb-4">Hover over rows to see the paper lift effect.</p>
            <Table>
              <TableHeader>
                <TableRow>
      ...
      >
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Vertical Scroll</h4>
            <p className="text-sm text-amber-600 mb-4">Scroll through content with paper-edge scrollbar.</p>
            <ScrollArea className="h-48 w-full rounded-md border border-amber-200 p-4">
              <div className="space-y-4">
                {[...Array(10)].map((_, i) => (
                  <div key={i} className="p-3 rounded bg-amber-50/50 border border-amber-100">
                    <p className="text-sm font-medium">Item {i + 1}</p>
                    <p className="text-xs text-amber-600">This is a scrollable paper item in the list.</p>
                  </div>
                ))}
              </div>
            </ScrollArea>
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Horizontal Scroll</h4>
            <p className="text-sm text-amber-600 mb-4">Horizontal scrolling for wide content.</p>
              ...
              <div className="flex gap-4">
                {[...Array(8)].map((_, i) => (
                  <div key={i} className="w-40 shrink-0 p-3 rounded bg-amber-50/50 border border-amber-100">
                    ...
                    <p className="text-xs text-amber-600">Horizontal scroll item</p>
                  </div>
                ))}
              </div>
            </ScrollArea>
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Long Text Content</h4>
      ...
      >
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Basic Collapsible</h4>
            <p className="text-sm text-amber-600 mb-4">Click to expand/collapse the content.</p>
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Multiple Collapsibles (FAQ Style)</h4>
      ...
      >
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Basic Marquee</h4>
            <p className="text-sm text-amber-600 mb-4">Horizontal infinite scroll with pause on hover.</p>
            <MarqueeContainer fadeWidth="w-1/6">
              <Marquee pauseOnHover className="[--duration:20s]">
                {["Figma", "Canva", "Adobe", "Sketch", "Framer"].map((brand) => (
                  <MarqueeItem key={brand}>
                    <span className="text-sm font-medium text-amber-700">{brand}</span>
                  </MarqueeItem>
                ))}
              </Marquee>
            </MarqueeContainer>
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Reverse Direction</h4>
            <p className="text-sm text-amber-600 mb-4">Marquee scrolling in reverse direction.</p>
            <MarqueeContainer fadeWidth="w-1/6">
              <Marquee reverse pauseOnHover className="[--duration:25s]">
                {["SVG", "PNG", "AI", "EPS", "PDF", "Figma"].map((format) => (
                  <MarqueeItem key={format}>
                    <span className="text-sm font-medium text-amber-700">{format}</span>
                  </MarqueeItem>
                ))}
              </Marquee>
            </MarqueeContainer>
          ...
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Without Fade Edges</h4>
            <p className="text-sm text-amber-600 mb-4">Full edge-to-edge scrolling without gradient fade.</p>
            <MarqueeContainer fadeEdges={false}>
              <Marquee pauseOnHover className="[--duration:15s]">
                {["Animals", "Nature", "Icons", "Patterns", "Textures"].map((category) => (
                  <MarqueeItem key={category}>
                    <span className="text-sm font-medium text-amber-700">{category}</span>
                  </MarqueeItem>
                ))}
              </Marquee>
            </MarqueeContainer>
      ...
      >
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">Basic Counter</h4>
            <p className="text-sm text-amber-600 mb-4">Numbers animate when the element enters the viewport.</p>
            <div className="flex items-center gap-8">
              <div className="text-center">
                <NumberTicker value={500} className="text-4xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Assets</p>
              </div>
              <div className="text-center">
                <NumberTicker value={12} className="text-4xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Categories</p>
              </div>
              <div className="text-center">
                <NumberTicker value={6} className="text-4xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Formats</p>
              </div>
            </div>
          </div>

          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">With Decimal Places</h4>
            <p className="text-sm text-amber-600 mb-4">Display numbers with decimal precision.</p>
            <div className="flex items-center gap-8">
              <div className="text-center">
                <NumberTicker value={4.9} decimalPlaces={1} className="text-4xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Rating</p>
              </div>
              <div className="text-center">
                <NumberTicker value={99.5} decimalPlaces={1} className="text-4xl font-bold" />
                <span className="text-2xl font-bold text-amber-600">%</span>
                <p className="text-sm text-amber-600 mt-1">Satisfaction</p>
              </div>
            </div>
          </div>

          <div>
            <h4 className="text-sm font-medium text-amber-800 mb-3">With Delay</h4>
            <p className="text-sm text-amber-600 mb-4">Staggered animation with custom delays.</p>
            <div className="flex items-center gap-8">
              <div className="text-center">
                <NumberTicker value={150} delay={0} className="text-3xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Illustrations</p>
              </div>
              <div className="text-center">
                <NumberTicker value={200} delay={0.3} className="text-3xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Icons</p>
              </div>
              <div className="text-center">
                <NumberTicker value={50} delay={0.6} className="text-3xl font-bold" />
                <p className="text-sm text-amber-600 mt-1">Patterns</p>
              </div>
            </div>
          </div>
        </div>
